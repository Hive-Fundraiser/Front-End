        ...
        {Array(8)
          ...
          .map((_, index) => (
            <div key={index} className="fundraise-panel-item">
              <div>
                <img alt="FundraisePanelItems" src={src} />
              </div>
              <div className="fundraise-panel-item-info">
                ...
                <div className="fundraise-panel-item-text">
                  مروز، همه در کنار هم روزهای سختی را سپری می‌کنیم. شیوع بیماری
                  کرونا شرایط سخت و پیچیده‌ای را به جهان و کشور عزیزمان تحمیل
                  نموده است. این شرایط برای کادر درمانی و حمایتی و خانواده‌های
                  بیماران پیچیدگی و سختی چند برابر ایجاد نموده است. نگرانی
                  بیماران و خانواده‌های آنها از یک سو و فشار کاری حاکم بر مراکز
                  درمانی و فعالیت بی وقفه و شبانه روزی کادر درمانی و حمایتی از
                  سوی دیگر و افزون بر همه آنها نگرانی فزاینده
                </div>
              </div>
