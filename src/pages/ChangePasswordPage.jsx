...
const ChangePasswordPage = () => {
  ...
  const submitHandler = (event) => {
    ...
    axios
      .post(
        "https://hive.iran.liara.run/auth/users/reset_password_confirm/",
        data
      )
      .then((response) => {
    ...
    <div className={styles.container}>
      <form onSubmit={submitHandler} className={styles.formContainer}>
        ...
        <div className={styles.formField}>
          ...
          />
          {errors.new_password && (
            <span className={styles.errorSpan}>{errors.new_password}</span>
          )}
        </div>
        <div className={styles.formField}>
          <input
          ...
          {errors.re_new_password && (
            <span className={styles.errorSpan}>{errors.re_new_password}</span>
          )}
        </div>
